  ...
  const handleSortChange = async (event) => {
    ...
    try {
      ...
      switch (selectedOption) {
        case "priceAsc":
          response = await axios.get("/sortItinerariesPriceAscendingGuest");
          break;
        case "priceDesc":
          response = await axios.get("/sortItinerariesPriceDescendingGuest");
          break;
...
<Box>
  <Button
    onClick={() => navigate('/GuestMuseum')} // Toggle dropdown for complaints
    sx={styles.sidebarButton}
  >
...
export default GuestitinerariesPage;
