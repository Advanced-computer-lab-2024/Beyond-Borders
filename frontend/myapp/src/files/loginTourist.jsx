...
const LoginTourist = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/loginTourist', formData);
      ...
      if (result.tourist) {
        ...
        setResponseMessage(`Welcome, ${result.tourist.Username}!`);

        // Redirect after 2 seconds
        setTimeout(() => {
          window.location.href = '/NewTouristHomePage'; // Redirect to home page after login
        }, 2000);
      } else {
  ...
  return (
    ...
    >
      <Typography variant="h4" align="center">Login Tourist</Typography>
