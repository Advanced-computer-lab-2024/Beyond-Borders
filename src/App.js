...
const {filterActivitiesGuest, getMuseumsByTagGuest, ViewAllUpcomingActivitiesGuest, ViewAllMuseumsGuest, getHistoricalPlacesByTagGuest} = require("./Routes/GuestController");
